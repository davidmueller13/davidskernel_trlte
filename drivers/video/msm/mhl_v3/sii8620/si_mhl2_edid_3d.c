...
uint8_t *mhl_get_edid(void)
{
	MHL_TX_DBG_INFO("get_edid\n");
	return g_EDID_block_data;
}
#endif
	...
	struct edid_3d_data_t *mhl_edid_3d_data)
{
	...
	print_hex_dump(KERN_INFO, "EDID = ",
		...
		g_EDID_block_data, 128 * (1 + g_EDID_block_data[0x7e]), false);
#endif
...
{
	uint16_t i;
	char hex_digits[0x10] = "0123456789ABCDEF";
